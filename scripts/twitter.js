...
function init() {
  ...
  map = new google.maps.Map(mapDiv, {
    center: new google.maps.LatLng(50.873911,4.714682),
    zoom: 6,
  ...
  distanceWidget = new DistanceWidget({
    ...
    color: '#000000',
    activeColor: '#5599bb',
    sizerIcon: new google.maps.MarkerImage('pics/icons/resize-off.png'),
    activeSizerIcon: new google.maps.MarkerImage('pics/icons/resize.png')
  });
