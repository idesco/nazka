...
function plotElevation(results) {
    ...
    chart.draw(data, {
      ...
      legend: 'none',
      titleY: 'Height (m)',
	  title: 'Move your mouse across the elevation profile',
...
function addMarker(latlng, doQuery) {
	if (markers.length < 10) {
      ...
      alert("Remove first the existing route by clicking on the blue button below. You can only add 10 points");
    }
  }
